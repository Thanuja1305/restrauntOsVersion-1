...
def main():
    ...
    # Execute database bootstrapper and seeder
    try:
        log_info("Running database bootstrapper and seeder...")
        subprocess.run([sys.executable, "backend/seed_supabase.py"], check=True)
        log_info("Database initialized successfully.")
    except Exception as e:
        log_error(f"Database seeder failed: {e}. Proceeding anyway...")
